...
class Contect(var id:String, var name: String, var emailid: String, var phoneNo: String, var address: String, var latitude: Double, var longitude: Double):Serializable{
